...
They *quantify the uncertainty* around the sample estimate. <br><br><br> In this episode, we'll explore how to **calculate**, **interpret**, and **visualize** confidence intervals.
